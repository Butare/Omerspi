...
<h3 align="center">Total By Department</h3>

<c:url var="printTotalByDepartmentUrl" value="/printTotalByDepartment.pdf"/>

<form:form method="POST" action="${printTotalByDepartmentUrl}?output=pdf">
