...
<script type="text/javascript">
    $(document).ready(function() {
        $('#category').change(function() {
            ...
            location.href='addOfficecAssetForm?categoryId='+categoryId;
        });
        
        $('#categoryType').change(function() {
            var categoryId=$('#category').val();
            var categoryTypeId = $(this).val();
            location.href='addOfficecAssetForm?categoryId='+categoryId+'&categoryTypeId='+categoryTypeId;
        });
...
<c:url var="saveUrl" value="addOfficeAsset"/>
<h3 align="center">Add Office Asset Item </h3><br/>
