...
<h3 align="center">Drivers and Transported Staffs</h3>

<c:url var="printTotalByDriverUrl" value="/driversAndTransportedStaff.pdf"/>

<form:form method="POST" action="${printTotalByDriverUrl}?output=pdf">
