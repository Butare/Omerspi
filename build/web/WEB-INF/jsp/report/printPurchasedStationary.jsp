...
<h3 align="center">Purchased Stock</h3>

<c:url var="printPurchasedStationaryUrl" value="stationaryRequisition/printPurchasedStationary.pdf"/>

<form:form method="POST" action="${printPurchasedStationaryUrl}?output=pdf">
