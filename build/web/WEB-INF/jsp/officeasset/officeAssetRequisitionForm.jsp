...
<c:url var="formUrl" value="addOfficecAssetForm"/>
...
<c:if test="${!empty requestedItemMap}">
    ...
    <form:form modelAttribute="officeAsset" method="GET" action="saveOrUpdateRequestedItems" >
        ...
        <div class="centered"> <table>
                ...
                <tr>
                    ...
                    <td><form:input path="beneficiary"/></td>
                </tr>
            </table></div>
    ...
    <c:if test="${empty requestedItemMap}">
    <br/> <p align="center"> You have not added any item to your office asset requisition </p>
</c:if>
</body>
</html>
